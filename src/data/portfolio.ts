...
export const portfolioData: PortfolioData = {
    ...
    projects: [
        ...
        },
        {
            ...
            tools: ['Python'],
            thumbnail: 'https://images.unsplash.com/photo-1614064641913-6b1e600dc35e?w=800&q=80',
            status: 'completed',
            startDate: '2026-01-01',
        ...
        },
        {
            ...
            tools: ['Python', 'Docker'],
            thumbnail: 'https://images.unsplash.com/photo-1504608524841-42584120d693?w=800&q=80',
            status: 'completed',
            startDate: '2026-01-01',
